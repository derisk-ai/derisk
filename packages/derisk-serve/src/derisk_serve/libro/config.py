...
APP_NAME = "libro"
SERVE_APP_NAME = "derisk_serve_libro"
SERVE_APP_NAME_HUMP = "derisk_serve_Libro"
SERVE_CONFIG_KEY_PREFIX = "derisk.serve.libro."
SERVE_SERVICE_COMPONENT_NAME = f"{SERVE_APP_NAME}_service"
# Database table name
SERVER_APP_TABLE_NAME = "derisk_serve_libro"
